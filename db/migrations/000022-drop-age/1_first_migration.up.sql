...
CREATE TABLE media.genre_characteristics_mapping (
    ...
    CONSTRAINT genre_characteristics_mapping_genre_fk FOREIGN KEY (genre_id) REFERENCES media.genres (id),
    CONSTRAINT genre_characteristics_mapping_characteristic_fk FOREIGN KEY (characteristic_id) REFERENCES media.genre_characteristics (id)
);
...
CREATE TABLE media.genre_descriptions (
    ...
    CONSTRAINT genre_descriptions_fk FOREIGN KEY (genre_id) REFERENCES media.genres(id)
);
